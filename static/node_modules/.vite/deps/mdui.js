...
var ReactiveElement = class extends HTMLElement {
  ...
  static getPropertyDescriptor(name, key, options) {
    ...
    return {
      get: get4,
      set(value) {
        const oldValue = get4 == null ? void 0 : get4.call(this);
        set4 == null ? void 0 : set4.call(this, value);
...
var render = (value, container2, options) => {
  ...
  const partOwnerNode = (options == null ? void 0 : options.renderBefore) ?? container2;
...
var ScrollBehaviorMixin = (superclass) => {
  class ScrollBehaviorMixinClass extends superclass {
    ...
    hasScrollBehavior(behavior) {
      var _a4;
      const behaviors = ((_a4 = this.scrollBehavior) == null ? void 0 : _a4.split(" ")) ?? [];
...
var LayoutManager = class {
  ...
  unregisterItem(element) {
    ...
    (_a4 = item.observeResize) == null ? void 0 : _a4.unobserve();
    this.items = void 0;
...
var LayoutItemBase = class extends MduiElement {
  ...
  onOrderChange() {
    var _a4;
    (_a4 = this.layoutManager) == null ? void 0 : _a4.updateOrder();
  }
  connectedCallback() {
    super.connectedCallback();
...
var ButtonBase = class extends AnchorMixin(RippleMixin(FocusableMixin(MduiElement))) {
  ...
  get focusElement() {
    var _a4, _b3;
    return this.isButton() ? (_a4 = this.renderRoot) == null ? void 0 : _a4.querySelector("._button") : !this.focusDisabled ? (_b3 = this.renderRoot) == null ? void 0 : _b3.querySelector("._a") : this;
  }
  get focusDisabled() {
    return this.disabled || this.loading;
  }
  ...
  return (proto, key) => {
    ...
    constructor.prototype.attributeChangedCallback = function(name, old, value) {
      ...
      if (name === attributeName) {
        ...
        const fromAttribute = isFunction(converter) ? converter : (converter == null ? void 0 : converter.fromAttribute) ?? defaultConverter.fromAttribute;
...
var Checkbox = class Checkbox2 extends RippleMixin(FocusableMixin(MduiElement)) {
  ...
  async onCheckedChange() {
    ...
    if (form && ((_a4 = formResets.get(form)) == null ? void 0 : _a4.has(this))) {
      this.invalid = false;
...
var Collapse = class Collapse2 extends MduiElement {
  ...
  async onActiveKeysChange() {
    ...
    const value = this.accordion ? (_a4 = this.items.find((item) => this.activeKeys.includes(item.key))) == null ? void 0 : _a4.value : this.items.filter((item) => this.activeKeys.includes(item.key)).map((item) => item.value);
    this.setValue(value);
    if (!this.isInitial) {
      this.emit("change");
    }
...
var lockScreen = (source, target) => {
  const document3 = getDocument();
  target ?? (target = document3.documentElement);
...
function runtimeMsg(templates2, template, options) {
  if (templates2) {
    const id2 = (options == null ? void 0 : options.id) ?? generateId(template);
...
var Dropdown = class Dropdown2 extends MduiElement {
  ...
  async onOpenChange() {
    ...
    if (this.open) {
      ...
      if (!this.hasTrigger("focus") && isFunction((_a4 = this.triggerElement) == null ? void 0 : _a4.focus) && (this.contains(document.activeElement) || this.contains(((_b3 = document.activeElement) == null ? void 0 : _b3.assignedSlot) ?? null))) {
  ...
  disconnectedCallback() {
    ...
    (_a4 = this.overflowAncestors) == null ? void 0 : _a4.forEach((ancestor) => {
      ancestor.removeEventListener("scroll", this.onWindowScroll);
    });
    (_b3 = this.observeResize) == null ? void 0 : _b3.unobserve();
  }
  firstUpdated(changedProperties) {
    super.firstUpdated(changedProperties);
  ...
  onDocumentKeydown(event) {
    ...
    if (event.key === "Tab") {
      if (!this.hasTrigger("focus") && isFunction((_a4 = this.triggerElement) == null ? void 0 : _a4.focus)) {
        event.preventDefault();
      }
      this.open = false;
    }
...
var LayoutItem = class LayoutItem2 extends LayoutItemBase {
  ...
  onPlacementChange() {
    var _a4;
    (_a4 = this.layoutManager) == null ? void 0 : _a4.updateLayout(this);
  }
  render() {
    return html`<slot></slot>`;
  }
...
var NavigationBarItem = class NavigationBarItem2 extends AnchorMixin(RippleMixin(FocusableMixin(MduiElement))) {
  ...
  get focusElement() {
    var _a4;
    return this.href ? (_a4 = this.renderRoot) == null ? void 0 : _a4.querySelector("._a") : this;
  }
  get focusDisabled() {
    return this.disabled;
  }
...
var NavigationDrawer = class NavigationDrawer2 extends LayoutItemBase {
  ...
  async onContainedChange() {
    var _a4;
    await this.definedController.whenDefined();
    (_a4 = this.observeResize) == null ? void 0 : _a4.unobserve();
...
var TextField = class TextField2 extends FocusableMixin(MduiElement) {
  ...
  get valueAsNumber() {
    var _a4;
    return ((_a4 = this.inputRef.value) == null ? void 0 : _a4.valueAsNumber) ?? parseFloat(this.value);
  }
...
var Select = class Select2 extends FocusableMixin(MduiElement) {
  ...
  getMenuItemLabelByValue(valueItem) {
    ...
    return ((_b3 = (_a4 = this.menuItems.find((item) => item.value === valueItem)) == null ? void 0 : _a4.textContent) == null ? void 0 : _b3.trim()) || valueItem;
  }
  resizeMenu() {
  ...
  onDropdownClose() {
    ...
    if (this.contains(document.activeElement) || this.contains(((_a4 = document.activeElement) == null ? void 0 : _a4.assignedSlot) ?? null)) {
      setTimeout(() => {
        this.focus();
      });
    }
...
var Tabs = class Tabs2 extends MduiElement {
  ...
  async onActiveKeyChange() {
    var _a4;
    await this.definedController.whenDefined();
    this.value = (_a4 = this.tabs.find((tab) => tab.key === this.activeKey)) == null ? void 0 : _a4.value;
    this.updateActive();
    if (!this.isInitial) {
      this.emit("change");
    }
  ...
  updateActive() {
    ...
    this.panels.forEach((panel) => {
      var _a4;
      return panel.active = panel.value === ((_a4 = this.activeTab) == null ? void 0 : _a4.value);
    });
    this.updateIndicator();
  }
  updateIndicator() {
...
var getTheme = (target = document.documentElement) => {
  ...
  return ((_a4 = Array.from(element.classList).find((className2) => themes.map((theme) => prefix2 + theme).includes(className2))) == null ? void 0 : _a4.slice(prefix2.length)) ?? "light";
};
...
var setFromSource = (source, options) => {
  const document3 = getDocument();
  const $target = $((options == null ? void 0 : options.target) || document3.documentElement);
  const schemes = {
  ...
  ((options == null ? void 0 : options.customColors) || []).map((color) => {
